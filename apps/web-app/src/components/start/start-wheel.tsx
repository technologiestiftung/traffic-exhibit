			...
			<div className="relative">
				<div className="pointer-events-none absolute inset-0 hidden lg:block">
					...
					<img
						src="/icon.svg"
						alt="car"
						className={`absolute -top-6 -right-30 w-43 2xl:w-55 hidden rotate-[45deg] items-center justify-center lg:flex ${animateDecorations ? "animate-pulse-scale-soft-slow" : ""}`}
					/>
				</div>
